...
function confirmAction(target, key) {
  swal.fire({
    title: "¡Confirma!",
    ...
    cancelButtonText: "No",
    customClass: {
      header: "text-base pl-2 text-left font-semibold text-color-dark",
      content: "text-xs pl-2 text-color-dark",
      confirmButton: "",
      cancelButton: ""
    }
  }).then(function (result) {
    if (result.isConfirmed) {
      console.log("Te remite al destino:" + target);
      console.log("Con la llave:" + key);
      console.log("O a una ruta: " + target + "/" + key);
      url = target + "/" + key;
      window.location.href = url;
    }
  });
